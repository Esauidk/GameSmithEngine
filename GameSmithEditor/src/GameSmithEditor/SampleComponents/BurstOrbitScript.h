...
namespace GameSmithEditor {
    ...
    public:
        BurstOrbitScript(GameSmith::GameObject* gameObject, GameSmith::Transform* transform) : Component(gameObject, transform) {
            m_Registry.AddExposedVariable("Num of Objects", GameSmith::ContainerDataType::Int, &m_NumObjs);
            m_Registry.AddExposedVariable("Origin Point", GameSmith::ContainerDataType::Float3, glm::value_ptr(m_Center));
