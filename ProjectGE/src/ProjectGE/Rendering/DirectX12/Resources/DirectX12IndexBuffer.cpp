...
namespace ProjectGE {
	DirectX12IndexBuffer::DirectX12IndexBuffer(unsigned short* buffer, unsigned int count) : m_Buffer(std::make_unique<DirectX12Buffer<unsigned short>>(buffer, count, "Index Buffer")), m_Count(count) {}
